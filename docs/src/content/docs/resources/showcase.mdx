...
<Showcase
  entries={[
    ...
    {
      thumbnail: import('../../../assets/showcase/docs.bobaboard.com.png'),
      href: 'https://docs.bobaboard.com/',
    ...
    {
      thumbnail: import('../../../assets/showcase/featureflip.io.png'),
      href: 'https://featureflip.io/docs/management-api/reference/',
      title: 'Featureflip',
    },
  ]}
/>
