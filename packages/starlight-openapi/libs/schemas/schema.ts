  ...
  .object({
    ...
    sidebar: z
      .object({
         ...
         */
        group: (z.any() as z.ZodType<StarlightOpenAPISidebarGroup>).optional(),
        /**
    ...
    /**
     * The snippets configuration controls autogenerated code examples shown on generated operation documentation pages.
     */
