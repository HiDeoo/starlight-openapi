...
export const SnippetsSchema = z
  .object({
    ...
    /**
     * Controls whether autogenerated request body snippets are available in request body sections for JSON-like and
     * URL-encoded form request body media types.
